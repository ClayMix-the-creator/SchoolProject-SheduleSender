...
def main():
    ...
    for event in longpoll.listen():
        if event.type == VkBotEventType.MESSAGE_NEW:
            ...
            if len(text) == 2 and text[0] == add_person_dict['name']:  # add_person_dict, add_person_func
            ...
            elif len(text) == 1 and text[0] == remove_person_dict['name']:  # remove_person_dict, remove_person_func
                ...
                if user_id in get_admins():
                    status = remove_class_func(text[3])
